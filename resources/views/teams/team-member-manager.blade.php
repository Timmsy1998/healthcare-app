<div>
    ...
    <div class="mt-10 sm:mt-0">
        <x-form-section submit="addPatientInformation">
            <x-slot name="title">
                {{ __('Add Patient Information') }}
            </x-slot>

            <x-slot name="description">
                {{ __('Add new patient information to your database.') }}
            </x-slot>
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-input id="first_name" type="text" class="mt-1 block w-full"
                        wire:model="patientForm.first_name" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-input id="last_name" type="text" class="mt-1 block w-full"
                        wire:model="patientForm.last_name" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-input id="email" type="email" class="mt-1 block w-full" wire:model="patientForm.email" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-input id="phone_number" type="tel" class="mt-1 block w-full"
                        wire:model="patientForm.phone_number" />
                    <x-input-error for="phone_number" class="mt-2" />
                </div>

                <!-- NHS Number -->
                <div class="col-span-6 sm:col-span-4">
                    <x-label for="nhs_number" value="{{ __('NHS Number') }}" />
                    <x-input id="nhs_number" type="text" class="mt-1 block w-full"
                        wire:model="patientForm.nhs_number" />
                    <x-input-error for="nhs_number" class="mt-2" />
                </div>

                <!-- Address -->
                <div class="col-span-6 sm:col-span-4">
                    <x-label for="address" value="{{ __('Address') }}" />
                    <x-input id="address" type="text" class="mt-1 block w-full" wire:model="patientForm.address" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-input id="date_of_birth" type="date" class="mt-1 block w-full"
                        wire:model="patientForm.date_of_birth" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <select id="sex" class="mt-1 block w-full" wire:model="patientForm.sex">
